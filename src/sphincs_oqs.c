...
void ejecutar_sphincs(const char* alg_id, int n, int repeticiones, const char* path_csv) {
    ...
    for (int i = 0; i < repeticiones; i++) {
        ...
        size_t mensaje_len = 32;  // puedes usar 32, 64, 128… según quieras
